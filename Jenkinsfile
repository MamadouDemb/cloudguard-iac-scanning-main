        ...
        stage('IaC-Shiftleft-Code-Scan') {
            ...
            steps {
                sh '''
                    ...
                    shiftleft iac-assessment --Infrastructure-Type terraform --path iac-code/aws --ruleset -64 --severity-level High --Findings-row --environmentId ec00ab44-b2a5-4d4d-9746-ffaa110dd3b4
                '''
            }
        }
